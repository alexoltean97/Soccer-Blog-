                ...
                <div class="rd-navbar-main-container container">
                  <!-- RD Navbar Nav-->
                                    <ul class="rd-navbar-nav">
                                      ...
                                      <li class="rd-nav-item active"><a class="rd-nav-link" href="typography.php">Typography</a>
                                      </li>
            ...
            <div class="row row-50">
              <div class="col-lg-5 text-center text-sm-left">
                ...
                <div class="group-md group-middle">
                  ...
                  </div><a class="button button-sm button-gray-outline" href="contact-us.php">Get in Touch</a>
                </div>
              </div>
              <div class="col-lg-7">
                <h5>Popular News</h5>
