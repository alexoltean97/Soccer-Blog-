     ...
     <div class="page"><a class="d-none d-xl-block" href="https://www.templatemonster.com/website-templates/allstar-multi-sports-website-template-63853.html" target="blank"><img class="d-block w-100" src="images/banner-free-01.jpg" alt=""></a>
                         ...
                         <div class="rd-navbar-panel-inner container">
                             ...
                             <div class="rd-navbar-panel-item rd-navbar-panel-item-right">
                                 <ul class="list-inline list-inline-bordered">
                                     ...
                                     <li><a class="link link-icon link-icon-left link-classic" href="login_admin.php"><span class="icon fl-bigmug-line-login12"></span><span class="link-icon-text">Login</span></a></li>
                                 </ul>
                             </div>
                         ...
                         <div class="rd-navbar-main-bottom rd-navbar-darker">
                             <div class="rd-navbar-main-container container">
                                 ...
                                 <ul class="rd-navbar-nav">
                                     ...
                                     <li class="rd-nav-item"><a class="rd-nav-link" href="game-overview.php">Game overview</a>
                                     </li>
      ...
      <!-- Swiper-->
     <?php require_once('templates/swiper.php');?>
